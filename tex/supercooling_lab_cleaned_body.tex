...
show that grapes generally experienced greater and more variable mass
loss compared to apples. Several grape samples showed substantial
decreases in mass, while apples typically showed smaller changes,
although some variation was still observed. This suggests that grapes
were more susceptible to water loss during the cooling and thawing
process. The apples had more significant mass loss in the acetone--dry 
ice bath than in the ice-water bath, which can be explained by cellular 
damage: when ice crystals form, they disrupt cell membranes, allowing 
intracellular water to leak out during thawing. Grapes, which have a higher
water content and have less structural integrity than apples show less of 
an increase in mass loss because the majority of the water in grapes is 
is liberated from transporting the fruit in and out of the container. 
For the brine group, any mass loss is not drip loss from thawing, 
because the fruit remained supercooled rather than frozen.

Texture observations further support this interpretation. Ice-water bath
samples were often described as softer, less firm, and more fragile,
while acetone-dry ice samples frequently appeared more fragile,
malleable, or watery, and in some cases slightly spongy or brittle.
These results indicate structural changes in both groups, but only the
acetone group underwent a freeze-thaw cycle. However, these observations 
are qualitative and should be interpreted with caution, as they were based 
on subjective descriptions rather than objective measurements.

Microscopic observations in Figure \ref{fig:grape40x} also showed evidence of structural disruption.
...
The literature says that faster freezing can reduce cell damage due to
the distribution of ice crystals being more even \cite{narayana2023}.
Flash freezing thus has a lesser effect on the cell structures and
textures of the fruits than slow cooling, but our observations do not
show that very clearly. That is expected, because the brine group was
supercooled and did not freeze, so ice crystal damage mainly applies to
the acetone group.
...
This assessment agrees with findings in scientific literature. Drip loss
is a cause for mass loss in foods that have undergone freezing and
thawing. In our experiment, grapes lost more mass than apples in Table
\ref{tab:mass}, which matches the qualitative texture analysis, where
the grape slices were initially described as juicy, slippery and
malleable while the apple slices were firmer and rougher. Figure
\ref{fig:massloss} shows the same tendency.

\contributor{Logan Joffre}

There was a general tendency for grapes to lose more mass than apples.
Table \ref{tab:mass} shows that the grape samples stayed in a similar
mass-loss range in both treatments, while the apples were lower in the
ice-water bath and higher in the acetone-dry ice bath. The cell
structure changes were also different between the fruits: grapes were
...
The acetone-dry ice mixture reached lower temperatures than the
ice-water mixture, but the lower temperature did not translate into
clearly better preservation. The brine group also remained supercooled
rather than frozen, so it did not follow the same damage pathway as the
acetone group.
